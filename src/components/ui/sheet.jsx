...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-card text-card-foreground p-6 shadow-float transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out',
  {
    variants: {
      side: {
...
const SheetContent = forwardRef(({ side = 'right', className, children, hideClose = false, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
